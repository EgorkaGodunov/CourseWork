class MainMenuScene extends Phaser.Scene
{
    constructor() {
      ...
      preload(){
        ...
        this.load.image('option_light','assets/button_option_light.png')
        this.load.image('option_dark','assets/button_option_dark.png')
      ...
      create() {
        ...
        this.optionButton = this.add.image(this.game.config.width * 0.5, this.game.config.height * 0.40,'option_light').setScale(this.scale).setInteractive().on('pointerdown',function(){
          console.log(2)
        },this)
        ...
        this.input.on('gameobjectmove',function(pointer, gameObject){
          if(this.checker){
            if(gameObject.texture.key == 'start_light'){
              ...
              this.optionButton.setTexture('option_dark')
            }
            this.checker = false
